...
export default function Navbar() {
    return (
        <nav className="sticky top-0 z-50 w-full border-b border-[var(--card-border)] bg-[var(--card-bg)]/80 backdrop-blur-xl supports-[backdrop-filter]:bg-[var(--card-bg)]/60">
            <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <Link href="/rankings" className="p-2 text-[var(--text-secondary)] hover:text-[var(--accent)] hover:bg-[var(--foreground)]/5 rounded-full transition-all" title="Rankings">
